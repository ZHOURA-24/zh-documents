  ...
  ["public"] = {
    ...
    },
    {
      ...
      elements = {
        ...
        { label = "NAMA DEBITUR", type = "input", value = "", can_be_emtpy = false },
        { label = "JUMLAH UTANG", type = "input", value = "", can_be_empty = false },
        { label = "INFORMASI LAINNYA", type = "textarea", value = "SAYA MENYATAKAN BAHWA DEBITUR TELAH MEMBAYAR PINJAMANNYA.", can_be_emtpy = false, can_be_edited = false },
      }
    }
  },
  ["police"] = {
    {
      ...
      elements = {
        ...
        { label = "INFORMASI", type = "textarea", value = "WARGA NEGARA YANG TERCANTUM BERHAK MENGGUNAKAN SENJATA SAMPAI BERAKHIRNYA DOKUMEN BERLAKU", can_be_emtpy = false },
      }
    },
    {
      ...
      elements = {
        ...
        { label = "RECORD", type = "textarea", value = "POLISI MENYATAKAN WARGA WARGA PUNYA REKAM YANG BERSIH SAMPAI AKHIR KEBERSAHAN DOKUMEN", can_be_emtpy = false, can_be_edited = false },
      }         }
  },
  ["ambulance"] = {
    {
      ...
      elements = {
        ...
        { label = "NAMA WARGA WARGA", type = "input", value = "", can_be_emtpy = false },
        { label = "BERLAKU SAMPAI", type = "input", value = "", can_be_empty = false },
        { label = "REKAM MEDIS", type = "textarea", value = "Warga tersebut di atas diperiksa oleh petugas kesehatan dan dinyatakan sehat tanpa penyakit jangka panjang yang terdeteksi. Laporan ini berlaku sampai dengan tanggal yang disebutkan", can_be_emtpy = false },
      }
    },
    {
      ...
      elements = {
        ...
        { label = "MEDICAL NOTES", type = "textarea", value = "Warga negara tersebut diperiksa oleh petugas kesehatan dan dinyatakan sehat mental dengan standar terendah yang disetujui. Laporan ini berlaku sampai dengan tanggal yang disebutkan.", can_be_emtpy = false },
      }
    },
    {
      ...
      elements = {
        ...
        { label = "INSURED LASTNAME", type = "input", value = "", can_be_emtpy = false },
        { label = "VALID UNTIL", type = "input", value = "", can_be_empty = false },
        { label = "MEDICAL NOTES", type = "textarea", value = "Warga tersebut diperiksa oleh petugas kesehatan dan dinyatakan sehat tanpa penyakit mata. Laporan ini berlaku sampai dengan tanggal yang disebutkan", can_be_emtpy = false },
      }
    },
  ...
  ["lawyer"] = {
    {
      ...
      elements = {
        ...
        { label = "NAMA WARGA WARGA", type = "input", value = "", can_be_emtpy = false },
        { label = "BERLAKU SAMPAI", type = "input", value = "", can_be_empty = false },
        { label = "INFORMASI", type = "textarea", value = "TDOKUMENNYA ADALAH BUKTI PERNYATAAN HUKUM DAN CAKUPAN WARGA NEGARA TERSEBUT. LAYANAN HUKUM BERLAKU SAMPAI TANGGAL BERAKHIRNYA DI ATAS", can_be_emtpy = false },
      }
    }
  }
}
